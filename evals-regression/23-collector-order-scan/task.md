...
including the full marker regex and `<touched Java files>` placeholder. Then classify all hard-stop
marker hits. Some markers are legitimate because of the domain notes; include those justifications
instead of deleting them from the audit.
